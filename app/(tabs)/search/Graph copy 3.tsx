...
function GraphnoRedux(props: any) {
  ...
  const editPolygon = (id: number, newPoints: string) => {
    setPolygons((prev) =>
      prev.map((polygon) =>
  ...
  return (
    <View>
      ...
      >
        {/* <Button
          title="Edit Polygon 1"
          onPress={() => editPolygon(1, "20,20 50,20 35,50")}
        />
        <Button
          title="Edit Polygon 2"
          onPress={() => editPolygon(2, "60,60 90,60 75,90")}
        /> */}
      </View>
