...
function ProfileDateScreenNoRedux(props: any) {
  ...
  return (
    <>
      <Text style={{ textAlign: "center", fontWeight: "bold" }}>
        Filtrar Fechas de los eventos reportados
      </Text>
      <Text></Text>
...
const ProfileDateScreen = connect(mapStateToProps, {
  EquipmentListUpper,
})(ProfileDateScreenNoRedux);
export default ProfileDateScreen;
